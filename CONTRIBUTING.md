...
```bash
$ git clone git@github.com:username/dbidi.git
```

This will clone your fork to your current path in a directory named `dbidi`.
...
```bash
$ cd dbidi
$ git remote add upstream git@github.com:ibm-dojo/dbidi.git
$ git fetch upstream
```
